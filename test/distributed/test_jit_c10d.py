...
def unique_process_group_name(suffix):
...
class ProcessGroupNCCLJitTest(JitTestCase):
    ...
    def _create_nccl_pg(self):
        ...
        name = unique_process_group_name("raw_process_group_nccl")
    ...
    def test_process_group_nccl_serialization(self):
        class TestModule(torch.nn.Module):
            def __init__(self, pg_nccl):
                ...
                name = unique_process_group_name("nccl_process_group_as_module_member")
                torch.classes.dist_c10d.frontend().register_process_group_name(self.pg, name)
